    ...
    <div className='w-full'>
      <div className='w-screen h-[50vh] relative'>
        ...
        <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
          <h2 className='py-2'>Ecommerce Clothing Shop App</h2>
          <h3>React JS / Tailwind CSS / Fake API</h3>
        </div>
      </div>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          <p>
            ...
            hosted on Vercel. Users are able to create a buy or add to cart a
            cloth or product from website. Another feature of this
            application is dynamic routing through the &quot;React Router DOM&quot;
            package. This application was built using the FAKE API.
          </p>
          <a
          ...
          <a
            href='https://ayush-bhosale.github.io/ecommerce-react-shop-main/'
            target='_blank'
            rel='noreferrer'
          >
