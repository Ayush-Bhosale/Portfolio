        ...
        <div className='grid lg:grid-cols-5 gap-8'>
          ...
          <div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4'>
            <div className='lg:p-4 h-full '>
              ...
              <div>
                <h2 className='py-2'>Ayush Bhosale</h2>
                <p>Web Developer</p>
                <p className='py-4'>
              ...
              <div>
                ...
                <div className='text-[#4db9e3] flex items-center justify-between py-4'>
                  <a
          ...
          <div className='col-span-3 w-full h-auto shadow-xl shadow-gray-400 rounded-xl lg:p-4'>
            <div className='p-4'>
              <form
                action='https://getform.io/f/168cf8e7-45b3-4d22-95b7-b3e2a10d2481'
                method='POST'
              ...
              >
                ...
                <button className=' text-[#f5f5f5] w-full p-4 mt-4'>
                  Send Message
                </button>
              </form>
            </div>
